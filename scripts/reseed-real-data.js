...
exports.REAL_STORES = exports.REAL_RESEARCHERS = void 0;
exports.recadastrarDadosReais = recadastrarDadosReais;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
exports.REAL_RESEARCHERS = [
    {
        id: 'pesq-giovani',
        nome: 'Giovani',
...
async function recadastrarDadosReais() {
    ...
    const numParaLojaId = new Map();
    for (const s of exports.REAL_STORES) {
    ...
    console.log(`✓ ${exports.REAL_STORES.length} lojas reais cadastradas.`);
    // 3. Cadastra os 9 pesquisadores com restrição explícita das suas lojas
    for (const r of exports.REAL_RESEARCHERS) {
    ...
    console.log(`✓ ${exports.REAL_RESEARCHERS.length} pesquisadores reais cadastrados com vinculação restrita de lojas.`);
}
